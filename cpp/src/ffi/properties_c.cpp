...
const char* loon_properties_writer_disable_compression_columns = PROPERTY_WRITER_DISABLE_COMPRESSION_COLUMNS;
const char* loon_properties_writer_disable_stats_columns = PROPERTY_WRITER_DISABLE_STATS_COLUMNS;
