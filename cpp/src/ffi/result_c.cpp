...
FFI_EXPORT const int loon_errcode_aws_not_found = LOON_AWS_ERROR_NOT_FOUND;
FFI_EXPORT const int loon_errcode_aws_access_denied = LOON_AWS_ERROR_ACCESS_DENIED;
FFI_EXPORT const int loon_errcode_aws_non_retryable = LOON_AWS_ERROR_NON_RETRYABLE;
