...
class VortexFile {
  public:
  static VortexFile Open(uint8_t* fs_rawptr, const std::string& path, uint64_t file_size = 0);
  static std::unique_ptr<VortexFile> OpenUnique(uint8_t* fs_rawptr, const std::string& path, uint64_t file_size = 0);
