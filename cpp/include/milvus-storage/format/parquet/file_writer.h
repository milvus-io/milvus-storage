...
class ParquetFileWriter : public internal::api::ColumnGroupWriter {
  ...
  arrow::Status AddMetadataAppender(const std::string& key, std::unique_ptr<MetadataAppender> appender);
  ...
  std::unordered_map<std::string, std::unique_ptr<MetadataAppender>> metadata_appenders_;
