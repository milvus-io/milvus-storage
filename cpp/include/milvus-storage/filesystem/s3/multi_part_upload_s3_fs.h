...
class MultiPartUploadS3FS : public arrow::fs::FileSystem {
  public:
  explicit MultiPartUploadS3FS(const S3Options& options, const int64_t part_size, const io::IOContext&)
  ...
  static arrow::Result<std::shared_ptr<MultiPartUploadS3FS>> Make(
      const S3Options& options, const int64_t part_size, const arrow::io::IOContext& = arrow::io::default_io_context());
