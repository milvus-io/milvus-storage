...
class ColumnGroups : public Serializable {
  ...
  /**
   * @brief Appends new files to existing column groups
   *
   * This method allows adding new physical file paths to existing
   * column groups. It is used when new data files are added to the dataset.
   *
