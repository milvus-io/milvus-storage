 ...
 */
const WriteProperties default_write_properties = {
  .max_row_group_size = 64 * 1024,
...
public:
  explicit SizeBasedColumnGroupPolicy(std::shared_ptr<arrow::Schema> schema, 
    int64_t max_avg_column_size, int64_t max_columns_in_group)
     : ColumnGroupPolicy(std::move(schema)), max_avg_column_size_(max_avg_column_size), max_columns_in_group_(max_columns_in_group) {
