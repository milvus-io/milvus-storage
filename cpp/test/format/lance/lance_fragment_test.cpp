...
TEST_F(LanceBasicTest, TestBasic) {
  ...
  {
    LanceFragmentWriter writer(base_path_, schema_, properties_);
...
TEST_F(LanceBasicTest, TestRead) {
  ...
  // test projection
  {
    ...
    LanceFragmentReader projection_reader(read_dataset, fragment_ids[0], projection_schema, properties_);
