...
// A raw OutOfMemory is retryable WITHOUT a detail -- arrow's own code is the
// classification, and the bridge restores marker 2 to exactly this shape. The
// gate treated "no detail" as "unclassified final verdict" and, on a size
// mismatch, rewrote memory pressure into ManifestCorrupted -- trading a retry
// that could succeed for a metadata alarm.
