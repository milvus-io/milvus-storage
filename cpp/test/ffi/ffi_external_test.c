...
static void test_column_groups_create(void) {
  ...
  // Test 1: Basic test with single file, no start/end indices
  {
    ...
    rc = column_groups_create((const char**)columns, 3, "parquet", paths, NULL, NULL, 1, &column_groups);
  ...
  // Should i verify the columns with schema?
  {
    ...
    rc = column_groups_create((const char**)columns, 2, "parquet", paths, NULL, NULL, 2, &column_groups);
  ...
  // Test 4: Error case - NULL columns
  {
    ...
    rc = column_groups_create(NULL, 1, "parquet", paths, NULL, NULL, 1, &column_groups);
  ...
  // Test 5: Error case - NULL paths
  {
    ...
    rc = column_groups_create((const char**)columns, 1, "parquet", NULL, NULL, NULL, 1, &column_groups);
  ...
  // Test 6: Error case - NULL format
  {
    ...
    rc = column_groups_create((const char**)columns, 1, NULL, paths, NULL, NULL, 1, &column_groups);
  ...
  // Test 7: Error case - zero columns
  {
    ...
    rc = column_groups_create((const char**)columns, 0, "parquet", paths, NULL, NULL, 1, &column_groups);
