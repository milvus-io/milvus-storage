...
class TestLongRunning:
    ...
    def test_manifest_growth_over_time(
        ...
        for i in range(num_appends):
            ...
            new_writer.write(batch_generator(50, offset=(i + 1) * 1000))
        ...
        expected_rows = 100 + num_appends * 50
